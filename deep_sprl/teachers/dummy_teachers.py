...
class UniformDiscreteSampler(AbstractTeacher):
    def __init__(self, contexts):
        self.contexts = np.reshape(contexts, (-1, contexts.shape[-1]))

    def sample(self):
        return self.contexts[np.random.randint(self.contexts.shape[0])]
