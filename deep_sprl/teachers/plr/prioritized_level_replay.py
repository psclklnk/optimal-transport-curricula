...
class PLRWrapper(BaseWrapper):
    ...
    def __init__(self, env, plr, discount_factor, context_visible, value_fn=None, lam=None,
        ...
        if context_post_processing is None:
            BaseWrapper.__init__(self, env, plr, discount_factor, context_visible,
                                 context_post_processing=plr.post_process)
        else:
            BaseWrapper.__init__(self, env, plr, discount_factor, context_visible,
                                 context_post_processing=lambda x: context_post_processing(plr.post_process(x)))
        self.state_trace = []
        self.reward_trace = []
        self.step_count = 0
