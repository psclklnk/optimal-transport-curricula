...
alg_params = {
    ...
    "gradient": [("GRADIENT_EPS", [0.05, 0.1, 0.2]), ("GRADIENT_DELTA", [0.6, 0.45, 0.3])],
    "wasserstein": [("METRIC_EPS", [2., 3., 4.]), ("DELTA", [0.6, 0.45, 0.3])],
}
...
def main():
    ...
    parser.add_argument("--type", type=str, default="alp_gmm", choices=["alp_gmm", "goal_gan", "acl", "plr", "vds",
                                                                        "gradient", "wasserstein"])
    parser.add_argument("--learner", type=str, default="ppo", choices=["ppo", "sac", "dqn"])
    parser.add_argument("--env", type=str, default="point_mass_2d", choices=["point_mass_2d", "sparse_goal_reaching",
                                                                             "unlockpickup"])
