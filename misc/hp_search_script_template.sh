...
#SBATCH -o /work/scratch/in86doko/hp_search_logs/{type}_hp_search_{env}_%A_%a.out
#SBATCH -e /work/scratch/in86doko/hp_search_logs/{type}_hp_search_{env}_%A_%a.err
